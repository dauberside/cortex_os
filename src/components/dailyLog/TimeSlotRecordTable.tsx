              ...
              >
                ...
                <td className="group relative border border-gray-300 px-1 py-1">
                  <div className="relative">
                    <input
                      ...
                      onFocus={() =>
                        !readOnly &&
                        setActiveQuickInput({ index, field: "water" })
                      }
                      disabled={readOnly}
                      className="w-full border-none bg-transparent px-1 py-0.5 text-center text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                      placeholder=""
                    />
                    {!readOnly &&
                      activeQuickInput?.index === index &&
                      activeQuickInput?.field === "water" && (
                        <div className="quick-input-dropdown absolute top-full left-0 z-20 mt-1 w-24 rounded-md border border-gray-300 bg-white shadow-lg">
                          {QUICK_INPUT_PRESETS.water.map((preset) => (
                            <button
                              key={preset}
                              type="button"
                              onClick={() =>
                                updateRecord(index, "water", preset)
                              }
                ...
                <td className="group relative border border-gray-300 px-1 py-1">
                  <div className="relative">
                    <input
                      ...
                      onFocus={() =>
                        !readOnly &&
                        setActiveQuickInput({ index, field: "meal" })
                      }
                      disabled={readOnly}
                      className="w-full border-none bg-transparent px-1 py-0.5 text-center text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                      placeholder=""
                        ...
                        <div className="quick-input-dropdown absolute top-full left-0 z-20 mt-1 w-24 rounded-md border border-gray-300 bg-white shadow-lg">
                          {QUICK_INPUT_PRESETS.meal.map((preset) => (
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                updateRecord(index, "meal", preset)
                              }
                              className="w-full px-2 py-1 text-left text-xs hover:bg-blue-50"
                            >
                              {preset}
                ...
                <td className="group relative border border-gray-300 px-1 py-1">
                  <div className="relative">
                    <input
                      ...
                      onFocus={() =>
                        !readOnly &&
                        setActiveQuickInput({ index, field: "condition" })
                      }
                      disabled={readOnly}
                      className="w-full border-none bg-transparent px-1 py-0.5 text-center text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                      placeholder=""
                    ...
                    {!readOnly &&
                      activeQuickInput?.index === index &&
                      activeQuickInput?.field === "condition" && (
                        <div className="quick-input-dropdown absolute top-full left-0 z-20 mt-1 w-24 rounded-md border border-gray-300 bg-white shadow-lg">
                          {QUICK_INPUT_PRESETS.condition.map((preset) => (
                            <button
                              ...
                              type="button"
                              onClick={() =>
                                updateRecord(index, "condition", preset)
                              }
                              className="w-full px-2 py-1 text-left text-xs hover:bg-blue-50"
                            >
                              {preset}
                  ...
                  <td className="group relative border border-gray-300 px-1 py-1">
                    <div className="relative">
                      <input
                        ...
                        onFocus={() =>
                          !readOnly &&
                          setActiveQuickInput({ index, field: "toilet" })
                        }
                        disabled={readOnly}
                        className="w-full border-none bg-transparent px-1 py-0.5 text-center text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                        placeholder=""
                      ...
                      {!readOnly &&
                        activeQuickInput?.index === index &&
                        activeQuickInput?.field === "toilet" && (
                          <div className="quick-input-dropdown absolute top-full left-0 z-20 mt-1 w-28 rounded-md border border-gray-300 bg-white shadow-lg">
                            {QUICK_INPUT_PRESETS.toilet.map((preset) => (
                              <button
                                key={preset}
                                type="button"
                                onClick={() =>
                                  updateRecord(index, "toilet", preset)
                                }
                                className="w-full px-2 py-1 text-left text-xs hover:bg-blue-50"
                              >
                                {preset}
                  ...
                  <td className="group relative border border-gray-300 px-1 py-1">
                    <div className="relative">
                      <input
                        ...
                        onFocus={() =>
                          !readOnly &&
                          setActiveQuickInput({ index, field: "sleep" })
                        }
                        disabled={readOnly}
                        className="w-full border-none bg-transparent px-1 py-0.5 text-center text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                        placeholder=""
                          ...
                          <div className="quick-input-dropdown absolute top-full left-0 z-20 mt-1 w-24 rounded-md border border-gray-300 bg-white shadow-lg">
                            {QUICK_INPUT_PRESETS.sleep.map((preset) => (
                              <button
                                ...
                                type="button"
                                onClick={() =>
                                  updateRecord(index, "sleep", preset)
                                }
                                className="w-full px-2 py-1 text-left text-xs hover:bg-blue-50"
                              >
                                {preset}
                ...
                <td className="border border-gray-300 px-1 py-1">
                  <input
                    ...
                    disabled={readOnly}
                    className="w-full border-none bg-transparent px-1 py-0.5 text-xs focus:ring-1 focus:ring-blue-500 focus:outline-none"
                    placeholder=""
                  />
                </td>
              </tr>
