  ...
  return (
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="border rounded-lg p-4 space-y-2">
            ...
            <label className="flex items-center gap-2 text-sm">
              ...
              <span>特別児童扶養手当 <span className="text-xs text-muted-foreground">（20歳未満・重度障害児の保護者）</span></span>
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" {...register("disabilityAllowance")} className="rounded" />
              <span>障害児福祉手当 <span className="text-xs text-muted-foreground">（20歳未満・重度障害で常時介護）</span></span>
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" {...register("specialDisabilityAllowance")} className="rounded" />
              <span>特別障害者手当 <span className="text-xs text-muted-foreground">（20歳以上・重度在宅で常時介護）</span></span>
            </label>
            <label className="flex items-center gap-2 text-sm">
              <input type="checkbox" {...register("nursingAllowance")} className="rounded" />
              <span>その他給付金・手当 <span className="text-xs text-muted-foreground">（各自治体の制度等）</span></span>
            </label>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border rounded-lg p-6 space-y-4">
        ...
        <p className="text-sm text-muted-foreground mb-4">65歳以上の方は介護保険が優先適用されます。障害福祉サービスの継続利用には申請が必要です。</p>
...
export default function NewRecipientPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-3xl">
      ...
      <h1 className="text-3xl font-bold mb-2">新規利用者登録</h1>
